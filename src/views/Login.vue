  ...
  <div class="top1">
    <div class="login" style="margin-top:40px">
      <div class="top">
        ...
        <form>
          <v-text-field v-model="email" class="abc" label="E-mail" required></v-text-field>
          <v-text-field v-model="password" class="abc" :type="'password'" label="Password" required></v-text-field>
