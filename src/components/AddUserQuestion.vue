      ...
      <v-card>
        ...
        <!-- <option v-for="item in Category" v-bind:key="item.id" :value="item.id" >{{item.name}}</option> -->
            ...
            <v-col cols="12">
              ...
              <v-col cols="12">
                <v-text-field placeholder="@username" label="TAG" type="text" required v-model="text2"></v-text-field>
              </v-col>
              <v-col cols="12" sm="6">
              </v-col>
            </v-row>
        ...
        <v-card-actions>
          ...
          <v-btn color="blue darken-1" text v-on:click="dialog = false" @click="submitClicked()">Submit</v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
  </v-row>
